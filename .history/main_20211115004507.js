...
const smallMenuCustom = document.getElementsByClassName('smallMenuCustom');
const smallMenuReadymade = document.getElementsByClassName('smallMenuReadymade');
const smallMenuEducation = document.getElementsByClassName('smallMenuEducation');
